    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('car_expense', models.DecimalField(blank=True, decimal_places=2, default=Decimal('0.00'), max_digits=10, null=True)),
                ...
                ('total_expenses', models.DecimalField(blank=True, decimal_places=2, default=Decimal('0.00'), max_digits=10, null=True)),
                ...
                ('driver_salary', models.DecimalField(decimal_places=2, default=Decimal('50000.00'), max_digits=10)),
                ('comments', models.CharField(default='leave message', max_length=100)),
                ('temp_field', models.CharField(blank=True, max_length=100, null=True)),
            ],
            options={
